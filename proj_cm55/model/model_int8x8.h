...
* 
* Generated at 02/09/2026 12:21:56 UTC. Any changes will be lost.
* 
* Model ID  ec56a226-f47b-4d50-8eee-c44042c01c4e
* 
* Memory    Size                      Efficiency
* Buffers   336600 bytes (RAM)        100 %
* State     3101712 bytes (RAM)       100 %
* Readonly  2414432 bytes (Flash)     100 %
* 
* Exported functions:
* 
*  @param data_in Input features. Input float[320,320,3].
*  @param data_out Output features. Output float[14,2100].
...
// Model GUID (16 bytes)
#define IMAI_MODEL_ID {0x26, 0xa2, 0x56, 0xec, 0x7b, 0xf4, 0x50, 0x4d, 0x8e, 0xee, 0xc4, 0x40, 0x42, 0xc0, 0x1c, 0x4e}
...
// data_in [320,320,3] (1228800 bytes)
#define IMAI_DATA_IN_RANK (3)
#define IMAI_DATA_IN_SHAPE (((int[]){3, 320, 320}))
#define IMAI_DATA_IN_COUNT (307200)
...
// data_out [14,2100] (117600 bytes)
#define IMAI_DATA_OUT_RANK (2)
#define IMAI_DATA_OUT_SHAPE (((int[]){2100, 14}))
#define IMAI_DATA_OUT_COUNT (29400)
...
// Profiling regions
    ...
    #define IMAI_REGIONS_NAMES {\
    	"BEST_FULL_INTEGER_QUANT_20260209",\
    	"DEQUANTIZE",\
    }
    typedef enum {
    	IMAI_BEST_FULL_INTEGER_QUANT_20260209 = 0,
    	IMAI_DEQUANTIZE = 1,
    } IMAI_Region_t;
#else
