...
* 
* Generated at 06/04/2026 12:52:54 UTC. Any changes will be lost.
* 
* Model ID  6a0b402c-499d-4c91-8b37-c1f32711a2d0
* 
* Memory    Size                      Efficiency
* Buffers   401700 bytes (RAM)        100 %
* State     891920 bytes (RAM)        100 %
* Readonly  1733008 bytes (Flash)     100 %
* 
* Exported functions:
* 
*  @param data_in Input features. Input float[320,320,3].
*  @param data_out Output features. Output float[6300,15].
...
// Model GUID (16 bytes)
#define IMAI_MODEL_ID {0x2c, 0x40, 0x0b, 0x6a, 0x9d, 0x49, 0x91, 0x4c, 0x8b, 0x37, 0xc1, 0xf3, 0x27, 0x11, 0xa2, 0xd0}
...
// data_out [6300,15] (378000 bytes)
#define IMAI_DATA_OUT_RANK (2)
#define IMAI_DATA_OUT_SHAPE ((int[]){15, 6300})
#define IMAI_DATA_OUT_COUNT (94500)
...
// Exported methods
void IMAI_compute(
	const float *restrict data_in, 
	float *restrict data_out);
