...
train_img_path = os.path.join(cwd, yolo_output + '/train/images')
train_txt_path = os.path.join(cwd, yolo_output + '/train/labels')
val_img_path = os.path.join(cwd, yolo_output + '/validation/images')
val_txt_path = os.path.join(cwd, yolo_output + '/validation/labels')
